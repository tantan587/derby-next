      ...
      <tr>
        <td align="center">
          ...
          <div style="width: 600px; font-family: 'Roboto'; font-size: 1.2em; margin: 30px; color: 'black';">
            <h3 style="text-align: left;">Congratulations, ${user.first_name}!</h3>
            <p style="text-align: left;">You have just created a new league at Derby Fantasy Wins League.</p>
            ...
            <p style="text-align: left;">
              ...
              Password: <b>${user.league_password}</b>
            </p>
            <p style="text-align: left;">You can also change your league settings and draft time on Derby Fantasy Wins League from the ${user.league_name} Commish Tools page.</p>

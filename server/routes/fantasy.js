...
router.post('/createleague', authHelpers.loginRequired, async (req, res)  => {
  return createLeague(req)
    .then(async (league_id) => { 
      console.log('league created')
      let user_info = await fantasyHelpers.buildLeagueSignUpEmail(req.user.user_id, req.body.leagueInfo)
      console.log(user_info)
      return authHelpers.sendEmail(user_info, createLeagueTemplate)
      .then(()=>{

...
const Dots = ({ st0, st1, style }) =>
  ...
  >
    ...
    <g id="Pattern">
    	<path fill={ st1 || "#CCCCCC" } d="M50.3,28.2c3.6,0,6.4,2.9,6.4,6.4c0,3.6-2.9,6.4-6.4,6.4s-6.4-2.9-6.4-6.4l0,0C43.9,31.1,46.8,28.2,50.3,28.2z
    		"/>
    	<path fill={ st0 || "#231F20" } d="M90.3,2.4c-1.3-0.9-2.9-1.1-4.4-0.6c0.9,0.5,2,0.7,3,0.7C89.4,2.5,89.9,2.5,90.3,2.4z"/>
    	<path fill={ st0 || "#231F20" } d="M76,15.4c3.6,0,6.5-2.8,6.5-6.4c0-1.5-0.5-3-1.5-4.1c-3.1-0.7-6.2-0.5-9.2,0.3l-1.2,0.4c-1.9,3-1,7,2,8.9
    		C73.6,15,74.8,15.4,76,15.4z"/>
    	<path fill={ st0 || "#231F20" } d="M101.8,15.4L101.8,15.4c3.5,0,6.4-2.8,6.4-6.4l-1.7-1.6l-4.2-4.1c-0.3,1.2-0.2,2.4,0.2,3.5
    	...
    	<path fill={ st0 || "#231F20" } d="M63.2,28.2c3.6,0,6.4-2.9,6.4-6.4c0-3.6-2.9-6.4-6.4-6.4c-0.7,0-1.3,0.1-1.9,0.3c0.1,0.3,0.2,0.5,0.3,0.8
    		c0.3,0.7,0.8,1.3,1.3,1.8c-2,0-3.6,0-5.1,0c-2,3-1.2,6.9,1.8,8.9C60.6,27.9,61.9,28.3,63.2,28.2L63.2,28.2z"/>
    	<path fill={ st0 || "#231F20" } d="M82.5,21.8c0,3.6,2.9,6.4,6.4,6.4c3.6,0,6.4-2.9,6.4-6.4s-2.9-6.4-6.4-6.4c-0.4,0-0.8,0-1.3,0.1l-1.9,0.7
    		C83.7,17.4,82.5,19.5,82.5,21.8z"/>
    	<path fill={ st0 || "#231F20" } d="M114.6,15.4c-3.1,0-5.8,2.2-6.3,5.3l4.9,0.7l0.1,1.9l4.2,0.9l1.6-4.5l-4.4-4.3L114.6,15.4L114.6,15.4z"/>
    	<circle fill={ st0 || "#231F20" } cx="50.3" cy="34.7" r="6.4"/>
    	<path fill={ st0 || "#231F20" } d="M82.5,34.7c0-3.6-2.9-6.4-6.4-6.4c-3.6,0-6.4,2.9-6.4,6.4c0,3.3,2.4,6,5.7,6.4c0.9-0.1,1.9-0.2,2.9-0.3
    		C80.7,39.8,82.5,37.4,82.5,34.7z"/>
    	<path fill={ st0 || "#231F20" } d="M101.8,41.1h0.2c-2.5-1.4-4.8-2.9-6.1-5.5c-0.2-0.6-0.4-1.2-0.5-1.9c-0.5,3.5,1.9,6.7,5.4,7.3
    		C101.1,41.1,101.4,41.1,101.8,41.1L101.8,41.1z"/>
    	<path fill={ st0 || "#231F20" } d="M88.9,41.1c-1.1,0-2.2,0.3-3.1,0.8l6.6,3.8h2.7C94.3,43,91.8,41.1,88.9,41.1z"/>
    	<path fill={ st0 || "#231F20" } d="M109.6,45.7c-0.3-0.3-0.6-0.5-0.9-0.8c-0.1,0.3-0.2,0.5-0.3,0.8H109.6z"/>
    </g>
  </svg>

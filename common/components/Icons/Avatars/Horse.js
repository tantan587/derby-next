const Horse = ({ st0, st1, style, pattern }) =>
{
  return <svg
    version="1.1"
    id="Layer_1"
        ...
        pattern.type === 'd' ?
          pattern.str.map((str,i) => {
            ...
            pattern.str.map((str,i) => {
              ...
              <circle fill={ st0 || '#555555' } cx="74.17" cy="28.15" r="9.19"/>
              : null
      }
    </g>
  </svg>

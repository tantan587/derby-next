...
Playoff Qualification bonus points are awarded at the conclusion of the given sport’s regular season. Championship Round Appearance bonus points are awarded when the affected team earns its berth in that round. Title Win bonus points are awarded when the winning team wins the title in its sport.
      ...
      <H3>
        <Top />
        <B>1. Time of Draft.</B> Each Derby league commissioner will set the date and time of the league’s draft. Drafts must be conducted through the Derby Web site offered at www.derby-fwl.com; we do not currently offer an offline draft option. All roster owners must be registered with an active Derby account and signed up for the particular league at least eight (8) hours prior to the set draft tim
        <Top />
        <B>2. No Order of Picks by Sport.</B> Teams from each sport may be selected in any order. Derby players determine when to select teams from each spor
        <Top />
        <B>3. Snake Format; Modifications.</B> The draft follows a standard snake format, i.e., the player who picks first in one round will pick last in the next round, and vice versa. Auction or other draft formats are not currently availabl
        <Top />
        <B>4. Draft Order.</B> Draft order will be randomly generated by our platfor
        <Top />
        <B>5. Time Limits to Make Picks.</B> Derby players will have 1 minute to make each selection. Players can place teams in their draft queues or select directly from the list of available team
        <Top />
        <B>6. Pre-Setting Draft Queues.</B> Individual players may pre-set draft queues with sufficient options to fill out all slots on their draft board
        <Top />
        <B>7. Expiration of Time to Pick with Queue Set.</B> If a player runs out of time before making his or her next pick, the team listed highest on his or her queue will be the default pic
        <Top />
        <B>8. Expiration of Time to Pick without Queue Set.</B> If a player runs out of time and does not have an eligible team listed in his or her queue, then any affected picks will be made automatically. The automatic pick will be based on the highest ranked team available and eligible for the player’s roster, according to the official Derby season projection
        <Top />
        <B>9. Player Offline at Time of Pick.</B> If a player is not present in the draft room at the time his or her draft selection comes, the pick will be made according to the player’s queue as set forth in Rule 7 above. If the player does not have a set queue with any eligible picks, the pick will be made at the expiration of five (5) seconds of the affected player’s time. At their own discretion, Commissioners may pause the draft during this five-second period in order to prevent automatic picks from occurring for a player who is offline.
        <Top />
        <B>10. Picks are Final; Pausing by Commissioner.</B> All picks are final and irreversible during the draft. Drafts can be paused by the Commissioner only. Upon the conclusion of the draft, Commissioners may revise picks at their own discretio
        <Top />
        <B>11. Draft Time Changes.</B> Draft dates and times can be updated as many times as is necessary up to three (3) hours prior to the set draft time. Commissioners can undertake these functions by visiting the Commish Tools pag
      </H3>
      <H2>League Rules</H2>
      <H3>
        <Top />

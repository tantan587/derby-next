...
const simulateProfessionalLeague = (all_games_list, teams, sport_id, simulations = 10) => {
    ...
    for(var x=0; x<simulations; x++){
        ...
        //find both finalists
        let finalist_1 = playoffFunctions[sport_id](sport_teams.filter(team => team.conference === leagues.leagues[sport_id].conferences[0]))
        let finalist_2 = playoffFunctions[sport_id](sport_teams.filter(team => team.conference === leagues.leagues[sport_id].conferences[1]))

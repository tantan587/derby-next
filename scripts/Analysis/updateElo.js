...
async function calculate_new_elos()
{
    ...
    .then(x => {
        ...
        rpiUpdate.cbbUpdateAllRpi(home_wins, away_wins, neutral_wins, home_losses, away_losses, neutral_losses);
...
function newFunction(home_wins, away_wins, neutral_wins, home_losses, away_losses, neutral_losses) {
    rpiUpdate.cbbRpiUpdateRows(home_wins, .6, 'win');
    rpiUpdate.cbbRpiUpdateRows(away_wins, 1.4, 'win');
    rpiUpdate.cbbRpiUpdateRows(neutral_wins, 1, 'win');
    rpiUpdate.cbbRpiUpdateRows(home_losses, 1.4, 'loss');
    rpiUpdate.cbbRpiUpdateRows(away_losses, .6, 'loss');
    rpiUpdate.cbbRpiUpdateRows(neutral_losses, 1, 'loss');
}

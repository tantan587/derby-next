...
const data = [
    ...
    {sport_id:103, scoring_type_id: 1, name: "default", regular_season: {win: 2, tie: 0, milestone_points: 15, milestones: [81, 90, 99]}, playoffs: {win: 5, bye:5}, bonus: {championship: 20, finalist: 20, appearance: 20}},
    {sport_id:104, scoring_type_id: 1, name: "default", regular_season: {win: 4, tie: 2, milestone_points: 15, milestones: [92, 100, 109]}, playoffs: {win: 4}, bonus: {championship: 20, finalist: 20, appearance: 20}},
